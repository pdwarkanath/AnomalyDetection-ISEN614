...
Where e<sub>j</sub> is the j<sup>th</sup> eigenvector of S and j &isin; {1,..,4}.
...
Where <span style="text-decoration:overline">y</span> is the mean of y, S<sub>y</sub> is the covariance matrix of y and i &isin; {1,2, ..., n} is the sample number.
